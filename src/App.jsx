...
function isText(name) { return ["txt","json","csv","js","ts","jsx","tsx","css","xml","yaml","yml"].includes(getExt(name)); }
function isMarkdown(name) { return getExt(name) === "md"; }
...
export default function App() {
  ...
  const globalStyle=`* { box-sizing: border-box; margin: 0; padding: 0; } html, body, #root { height: 100%; } body { background: ${C.bg}; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; -webkit-font-smoothing: antialiased; } ::-webkit-scrollbar { width: 4px; height: 4px; } ::-webkit-scrollbar-track { background: transparent; } ::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.08); border-radius: 99px; } input, select, textarea, button { font-family: inherit; } input[type=date]::-webkit-calendar-picker-indicator { filter: invert(0.4); } select option { background: ${C.surface2}; } @keyframes spin { to { transform: rotate(360deg); } } @keyframes pulse { 0%,100%{opacity:1;}50%{opacity:0.4;} } @keyframes toastIn { from { opacity:0; transform:translateX(12px) scale(0.96); } to { opacity:1; transform:translateX(0) scale(1); } } a { text-decoration: none; } .md-body{color:${C.text1};font-size:14px;line-height:1.8;word-break:break-word;} .md-body h1,.md-body h2,.md-body h3,.md-body h4{color:#f8fafc;font-weight:700;margin:1.4em 0 0.5em;line-height:1.3;} .md-body h1{font-size:1.7em;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:0.3em;} .md-body h2{font-size:1.35em;border-bottom:1px solid rgba(255,255,255,0.06);padding-bottom:0.2em;} .md-body h3{font-size:1.1em;} .md-body p{margin:0.8em 0;} .md-body a{color:${C.accent};} .md-body code{background:rgba(255,255,255,0.08);border-radius:4px;padding:0.15em 0.45em;font-size:0.87em;font-family:monospace;} .md-body pre{background:rgba(0,0,0,0.35);border-radius:8px;padding:16px;overflow-x:auto;margin:1em 0;} .md-body pre code{background:none;padding:0;font-size:0.85em;} .md-body blockquote{border-left:3px solid ${C.accent};margin:1em 0;padding:0.4em 1em;color:${C.text2};} .md-body ul,.md-body ol{padding-left:1.6em;margin:0.8em 0;} .md-body li{margin:0.3em 0;} .md-body table{border-collapse:collapse;width:100%;margin:1em 0;font-size:13px;} .md-body th,.md-body td{border:1px solid rgba(255,255,255,0.1);padding:8px 12px;text-align:left;} .md-body th{background:rgba(255,255,255,0.06);font-weight:600;} .md-body hr{border:none;border-top:1px solid rgba(255,255,255,0.1);margin:1.5em 0;} .md-body img{max-width:100%;border-radius:8px;margin:0.5em 0;}`;
